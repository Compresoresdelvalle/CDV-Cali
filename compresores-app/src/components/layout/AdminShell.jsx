...
function LogoutIcon() {
  return (
    ...
    >
      <path
        d="M6.75 15.75H3.75A1.5 1.5 0 0 1 2.25 14.25V3.75A1.5 1.5 0 0 1 3.75 2.25h3M12 12.75 15.75 9 12 5.25M15.75 9H6.75"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export default function AdminShell() {
  ...
  const SidebarContent = ({ iconsOnly = false }) => (
    ...
    >
      {/* Logo */}
      <div
        className={`border-b border-white/8 flex-shrink-0 ${iconsOnly ? "px-2 py-4 flex justify-center" : "px-5 py-5"}`}
      >
        {iconsOnly ? (
          <div
      ...
      {!iconsOnly && (
        <div className="px-5 py-3.5 border-b border-white/8 flex-shrink-0">
          ...
          <span className="text-[11px] font-semibold text-[#E94560] mt-0.5 inline-block">
            Admin
          </span>
        </div>
      )}
      ...
      {/* Módulos */}
      <nav
        className={`flex-1 overflow-y-auto py-3 ${iconsOnly ? "px-2 space-y-1" : "px-3 space-y-0.5"}`}
      >
      ...
      {/* Footer */}
      <div
        className={`border-t border-white/8 flex-shrink-0 py-3 space-y-0.5 ${iconsOnly ? "px-2" : "px-3"}`}
      >
        {iconsOnly ? (
          <>
            <NavLink
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-[#E94560] bg-[#E94560]/10 px-2 py-0.5 rounded-full">
              Admin
            </span>
          </div>
