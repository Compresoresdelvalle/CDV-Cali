...
export default function CotizacionEditar() {
  ...
  return (
    ...
    >
      {/* ── PageHeader ── */}
      <PageHeader
        title={`Editar Cotización #${numero}`}
        description={
          volveraaBorrador ? "Al guardar, volverá a estado Borrador" : undefined
        }
        actions={
          <button
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Agregar por nombre o referencia..."
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 rounded-lg text-white flex-shrink-0 cursor-pointer"
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="w-7 h-7 rounded-lg flex items-center justify-center border text-base cursor-pointer"
                      style={{
                        borderColor: "hsl(var(--border))",
                        color: "hsl(var(--muted-foreground))",
                      }}
