...
export const ROLE_MODULES = {
  Admin:     ['Inventario', 'Ventas', 'Compras', 'Traspasos', 'Órdenes', 'Ensambles', 'Cotizaciones', 'Herramientas', 'Devoluciones', 'Productos', '→ Panel Admin'],
  Bodeguero: ['Inventario', 'Compras', 'Traspasos', 'Ensambles', 'Devoluciones', 'Herramientas', 'Productos'],
  Vendedor:  ['Inventario', 'Ventas', 'Cotizaciones', 'Herramientas', 'Productos'],
