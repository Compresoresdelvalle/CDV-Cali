-- COT-C: guarda de rol Admin/Vendedor. COT-G: total no puede quedar por debajo de lo ya abonado.
...
begin
  ...
  -- COT-G: el total no puede quedar por debajo de lo ya abonado
  ...
  if v_total < v_abonado then
    raise exception 'El total (%) no puede quedar por debajo de lo ya abonado en la cotización (%)', v_total, v_abonado;
  end if;
