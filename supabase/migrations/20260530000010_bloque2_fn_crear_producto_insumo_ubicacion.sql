-- ============================================================================
-- Bloque 2 — A5: fn_crear_producto ahora persiste vendible / stand / posicion
-- desde el payload (el form ya los envía). Aditivo: mismo comportamiento para
-- los campos existentes; solo agrega 3 columnas al INSERT.
-- ============================================================================
