-- Auditoría 2026-06-28 (continuación) — mismo doble conteo de OT que el cierre,
-- pero en el DASHBOARD del admin. `fn_dashboard_kpis.ingresos_servicios_mes`
-- sumaba ventas origen='ot' + abonos OT (venta_id null), así que el dinero de una
-- OT se contaba dos veces (o mal, en sobre-abonos).
-- FIX: contar el dinero de OT SOLO vía `abonos` por su fecha (sin importar venta_id),
-- consistente con _fn_cierre_totales. Resto del KPI sin cambios.
