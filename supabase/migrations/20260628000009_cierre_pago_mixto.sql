-- ============================================================================
-- Pago mixto (#2) — parte CIERRE. _fn_cierre_totales reparte las ventas con
-- metodo_pago='Mixto' por su desglose en pagos_venta, en los 4 lugares donde el
-- cierre separa por forma de pago: por_metodo, por_sede_metodo, por_cuenta y el
-- arqueo de efectivo. El total de ingresos NO cambia (una venta mixta sigue
-- contando su total una sola vez; solo se reparte CÓMO se pagó). Sin doble conteo.
-- Todo lo demás queda idéntico a la versión de caja real.
-- ============================================================================
